...
// Preloader disabled: removed automatic creation to avoid showing the dot-loader on refresh.
// If you want the preloader back for testing, instantiate it manually in the console:
...
window.addEventListener("load", async () => {
  ...
  // Ensure the slider wrapper is visible even when the preloader is disabled
  const sliderWrapper = document.querySelector('.slider-wrapper');
